 ...
 * ============================================================================
 * 
 * Defines endpoint URLs, geolocation anchors, administrative authorizations,
 * Meta Messenger integrations, and standard delivery fare matrices.
 * 
 * Update Note:
 * - Removed secondary rider ID from ADMIN_IDS so rider accounts cannot be
 *   inadvertently hardcoded as Admin Exempt in the commission ledger.
 * ============================================================================
 */
