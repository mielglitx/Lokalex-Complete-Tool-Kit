...
function registerRoute(capture, handler, method) {
	...
	if (typeof capture === "string") {
		...
		{
			if (!(capture.startsWith("/") || capture.startsWith("http"))) throw new WorkboxError("invalid-string", {
				moduleName: "workbox-routing",
				funcName: "registerRoute",
				paramName: "capture"
			});
...
//#endregion
export { Route as a, RegExpRoute as i, getOrCreateDefaultRouter as n, Router as r, registerRoute as t };
