...
import { a as Route, t as registerRoute } from "./registerRoute-B4DPYvmD.js";
import { n as cacheNames } from "./quotaErrorCallbacks-DQ5qTn8h.js";
import { t as Strategy } from "./Strategy-CtZy7a_t.js";
	...
	async _handleFetch(request, handler) {
		...
		if (this._fallbackToNetwork) {
			...
			if (integrityInManifest && noIntegrityConflict && request.mode !== "no-cors") {
				...
				if (await handler.cachePut(request, response.clone())) logger.log(`A response for ${getFriendlyURL(request.url)} was used to "repair" the precache.`);
			}
...
//#endregion
//#region node_modules/workbox-precaching/addPlugins.js
/**
...
function addPlugins(plugins) {
	getOrCreatePrecacheController().strategy.plugins.push(...plugins);
}
//#endregion
...
function addRoute(options) {
	const precacheRoute = new PrecacheRoute(getOrCreatePrecacheController(), options);
...
//#endregion
//#region node_modules/workbox-precaching/getCacheKeyForURL.js
/**
...
function getCacheKeyForURL(url) {
	return getOrCreatePrecacheController().getCacheKeyForURL(url);
}
//#endregion
...
//#endregion
//#region node_modules/workbox-precaching/PrecacheFallbackPlugin.js
/**
